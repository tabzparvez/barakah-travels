  ...
  return (
    ...
    >
        ...
        <div className="text-right">
          ...
          <span
            className={`inline-block mt-2 px-3 py-1 rounded text-white text-xs ${
              data.balance > 0 ? "bg-red-600" : "bg-green-600"
            }`}
          >
            {data.balance > 0 ? "PENDING" : "PAID"}
          </span>
        </div>
      </div>
      ...
      <table className="w-full border border-black border-collapse mb-4">
        ...
        <tbody>
          <tr>
            ...
            <td className="border border-black p-2 text-center">{data.qty}</td>
      ...
      <p className="text-xs mb-3">
        <strong>Amount in Words:</strong> {amountToWords(Number(data.total))} only
      </p>
      ...
      <div className="text-xs mt-4">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>All payments once made are non-refundable.</li>
          <li>
            Any increase in government taxes or airline charges will be payable
            by customer.
          </li>
          <li>
            Barakah Travels is not responsible for delays due to airline, visa or
            weather conditions.
          </li>
        </ul>
      </div>
      ...
      <div className="flex justify-between mt-10 text-xs">
        <div>
          <p>Prepared By</p>
          <p className="font-bold mt-4">Tabish Parvez</p>
        </div>
        <div className="text-right">
      ...
      <div className="mt-6 no-print">
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={() => router.push(`/admin/invoices/${params.id}/edit`)}
